...
const scrollNav = () => {
  ...
  const gallerySection = document.querySelector("#gallery").getBoundingClientRect().y;
  ...
  } else if (position >= projectsSection && position < gallerySection && !projects.classList.contains("active")) {
    document.querySelector(".active").classList.remove("active");
    projects.classList.add("active");
  } else if (position >= gallerySection && position < contactSection && !gallery.classList.contains("active")) {
    document.querySelector(".active").classList.remove("active");
...
document.querySelector(".fill-form").addEventListener("focusout", (event) => {
  ...
  if (event.target.value.length < 1 && event.target.hasAttribute("required")) {
    event.target.style.border = "1px solid #C8102E";
  }
  ...
  if (event.target.value.length < 1 && event.target.hasAttribute("required")) {
    ...
    event.target.style.border = "0px solid #C8102E";
  }
});
